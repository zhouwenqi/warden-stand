...
-- ----------------------------
INSERT INTO `wd_sys_config` VALUES ('\0', '\0');
...
CREATE TABLE `wd_sys_login_log` (
  ...
  `update_date` datetime NOT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=172 DEFAULT CHARSET=utf8mb4 COMMENT='登录日志';
...
CREATE TABLE `wd_sys_message` (
  ...
  `read` bit(1) DEFAULT b'0' COMMENT '已读',
...
CREATE TABLE `wd_sys_operation_log` (
  ...
  `update_date` datetime NOT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=780 DEFAULT CHARSET=utf8mb4 COMMENT='操作日志';
...
INSERT INTO `wd_sys_permission` VALUES ('32', '创建统系公告', 'notice:create', '25', '2023-09-17 16:02:14', '2023-09-17 16:02:16');
INSERT INTO `wd_sys_permission` VALUES ('33', '修改系统公告', 'notice:modify', '26', '2023-09-17 16:02:39', '2023-09-17 16:02:41');
INSERT INTO `wd_sys_permission` VALUES ('34', '删除系统公告', 'notice:delete', '27', '2023-09-17 16:03:05', '2023-09-17 16:03:07');
INSERT INTO `wd_sys_permission` VALUES ('35', '推送系统公告', 'notice:push', '28', '2023-09-17 16:03:32', '2023-09-17 16:03:35');
...
INSERT INTO `wd_sys_role_user` VALUES ('7', '39');
...
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8mb4 COMMENT='系统用户';

-- ----------------------------
-- Records of wd_sys_user
-- ----------------------------
INSERT INTO `wd_sys_user` VALUES ('1', 'superman', '$2a$10$YrLdiL24WJ6xmVkzqmppy.gqusqocT56kRlXv5Y1Ij5J6IpF/ka9i', '超级管理员', 'chaojiguanliyuan', 'cjgly', '0', '13875928333', 'i.lawnwmlglo@qq.com', '/face/bdfa4baee76bb3a4c5b43cd13058a017.jpeg', null, '1', '\0', '\0', '2023-07-03 16:20:24', '2023-09-11 11:12:43');
...
INSERT INTO `wd_sys_user` VALUES ('39', 'xiaoma', '$2a$10$dxRmt6rUHvnT0Qr8hwAcueBCYUJCbxAFASDwb7bt7wrFHHc/OcZaW', '小马', 'xiaoma', 'xm', '0', '18988884877', '735878602@qq.com', '', null, '7', '\0', '\0', '2023-09-07 09:43:34', '2023-09-08 08:31:21');
INSERT INTO `wd_sys_user` VALUES ('40', 'xiaoma8', '$2a$10$tjuAKt6ARz2mq2RseIEuKOIW3We49Lxjvwpv9QPvT8z7bLsae15wS', null, null, null, '2', null, '735878602@qq.com', null, null, null, '\0', '\0', '2023-09-12 10:11:54', '2023-09-12 10:11:54');
